...
from models import Autoformer, DLinear, TimeLLM_double_attention, TimeLLM_attention
...
from utils.tools import del_files, EarlyStopping, adjust_learning_rate, vali, vali_contrast, load_content
...
accelerator = Accelerator(kwargs_handlers=[ddp_kwargs], deepspeed_plugin=deepspeed_plugin, mixed_precision=args.mixed_precision)
    ...
    for epoch in range(args.train_epochs):
        ...
        for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in tqdm(enumerate(train_loader)):
            ...
            if args.use_amp:
                ...
                # loss = loss_mse + contrast_loss/(contrast_loss/loss_mse).detach()
                # loss = loss_mse/loss_mse.detach() + contrast_loss/contrast_loss.detach()
                w = 0.3
