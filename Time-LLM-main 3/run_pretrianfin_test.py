...
for data_path in companies:
    ...
    for ii in range(args.itr):
        ...
        test_loss, test_mae_loss =  test_loss.item(), test_mae_loss.item()

        accelerator.print(
            "Test Loss: {:.7f} MAE Loss: {:.7f}".format(
    ...
    mses.append(np.mean(test_loss))
    maes.append(np.mean(test_mae_loss))
